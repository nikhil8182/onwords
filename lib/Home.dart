...
class Home extends StatefulWidget {
  ...
  bool isDarkMode,check_url;
   Home(this.email,this.ipAddress,this.isDarkMode,this.check_url);
  @override
            ...
            child: ListView(
              ...
              children: [
               ...
               /* InkWell(
                ...
                InkWell(
                  onTap: (){
                    Navigator.push(context, MaterialPageRoute(builder: (context)=>About(widget.email,g1,widget.isDarkMode,widget.ipAddress)));
                  },
                  child: Container(
                    padding: EdgeInsets.all(10),
                    child: Row(
